---
title: "Differential expression (DESeq2) and GSEA nalysis for STAT1GOF and STAT1LOF (matched ages)"
...
for (each in c("STAT1GOF_Older_Tnn", "STAT1GOF_Older_Tn","STAT1GOF_Adults_Tnn", "STAT1GOF_Adults_Tn")){
...
gseafunc <- function(gmtfile, pval_cutoff, gene_sets){
  for (each in c("STAT1GOF_Older_Tnn", "STAT1GOF_Older_Tn","STAT1GOF_Adults_Tnn", "STAT1GOF_Adults_Tn")){
      ...
      # output the table
      fwrite(fgseaRes_filtered, file=paste0("./STAT1_age_groups/GSEA/enriched_genesets_", gene_sets,"_",comp,".tsv"), sep="\t", sep2=c("",",",""))
...
for (each in c("STAT1GOF_Older_Tnn", "STAT1GOF_Older_Tn","STAT1GOF_Adults_Tnn", "STAT1GOF_Adults_Tn")){
      ...
      # output the table
      fwrite(fgseaRes, file=paste0("./STAT1_age_groups/GSEA/enriched_genesets_Exhaustion_genesets","_",comp,".tsv"), sep="\t", sep2=c("",",",""))
