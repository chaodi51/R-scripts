---
title: "Differential expression (DESeq2) and GSEA nalysis for STAT3GOF and STAT3LOF"
...
res_STAT3GOF_Young_Tnn[rownames(res_STAT3GOF_Young_Tnn) %in% c("STAT3","TOX"),]
...
res_STAT3GOF_Adults_Tnn[rownames(res_STAT3GOF_Adults_Tnn) %in% c("STAT3","TOX"),]
...
res_STAT3GOF_Adults_Tn[rownames(res_STAT3GOF_Adults_Tn) %in% c("STAT3","TOX"),]
```
...
res_STAT3LOF_Young_Tnn[rownames(res_STAT3LOF_Young_Tnn) %in% c("STAT3","TOX"),]
...
res_STAT3LOF_Young_Tn[rownames(res_STAT3LOF_Young_Tn) %in% c("STAT3","TOX"),]
...
res_STAT3LOF_Older_Tnn[rownames(res_STAT3LOF_Older_Tnn) %in% c("STAT3","TOX"),]
...
res_STAT3LOF_Older_Tn[rownames(res_STAT3LOF_Older_Tn) %in% c("STAT3","TOX"),]
```


### Volcano plots {-}
```{r message=FALSE, warning = FALSE, fig.height=8, fig.width=7, fig.show="hold"}
for (each in c("STAT3GOF_Young_Tnn", "STAT3GOF_Adults_Tnn", "STAT3GOF_Adults_Tn", "STAT3LOF_Young_Tnn", "STAT3LOF_Young_Tn", "STAT3LOF_Older_Tnn", "STAT3LOF_Older_Tn")){
...
gseafunc <- function(gmtfile, pval_cutoff, gene_sets){
    for (each in c("STAT3GOF_Young_Tnn", "STAT3GOF_Adults_Tnn", "STAT3GOF_Adults_Tn", "STAT3LOF_Young_Tnn",
                   "STAT3LOF_Young_Tn", "STAT3LOF_Older_Tnn", "STAT3LOF_Older_Tn")){
      # print comparison
      comp <- sub("Tn","CD8Tn", sub("_"," ", each))
      print(comp)
      res = get(paste0("res_",each))
